...
// function moveDuck(){
//   let moveLeft =Math.floor( Math.random() * window.innerWidth) + 'px'
//   let moveTop = Math.floor(Math.random() * window.innerHeight) + 'px'
//   duck.style.left = moveLeft
//   duck.style.top = moveTop
...
// duck.addEventListener('click', function(){duck.classList.add('shot')})
...
function checkForWinner(){
  console.log(document.body.contains(document.querySelector('div')))
  if(document.body.contains(document.querySelector('div')) === false){
...
// winCheck =  setInterval(checkForWinner,1000)
// if((document.body.contains(document.querySelector('div')) === false))
// {
